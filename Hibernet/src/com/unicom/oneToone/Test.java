...
//		}
		Husband hus =(Husband) session.get(Husband.class, "8ab8dab2493afcbb01493afcbc920001");
		System.out.println(hus.getWife().getId());
		session.getTransaction().commit(); 
	}
	 public void delete(){
		 ...
		 session.beginTransaction();
		 Husband hus =(Husband) session.get(Husband.class, "8ab8dab2493afcbb01493afcbc920001");
		 Wife wife =(Wife) session.get(Wife.class, "8ab8dab2493afcbb01493afcbc920001");
		 //session.delete(wife);	//ObjectDeletedException deleted object would be re-saved by cascade
